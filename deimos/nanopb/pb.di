...
version(PB_FIELD_16BIT)
	private enum ISDEF_PB_FIELD_16BIT = true;
else
	private enum ISDEF_PB_FIELD_16BIT = false;

version(PB_FIELD_32BIT)
	private enum ISDEF_PB_FIELD_32BIT = true;
else
	private enum ISDEF_PB_FIELD_32BIT = false;
...
@property auto pb_membersize(st, string m)() { return st.mixin(m).sizeof; }
